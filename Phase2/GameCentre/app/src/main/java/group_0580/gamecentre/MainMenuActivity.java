...
public class MainMenuActivity extends AppCompatActivity implements ServiceConnection {
    ...
    /**
     * Initialises the loaded game
     *
     * @return an intent with loaded game data
     */
    private Intent initLoadGame() {
        Intent load = new Intent(MainMenuActivity.this, GameActivity.class);
        ...
        // Adding extra required data to be passed to GameActivity
        load.putExtra("background_path", userManager.getBackgroundPath());
        load.putExtra("game", userManager.getSavedGame());
